...
# Define tasks: (Script Path, Name) - v26.8 Active Pipeline
TASKS = [
...
def exorcise_legacy_processes():
    """Rule 1 & 2: Singular RAM Dominance & Ruthless Purge (v26.8)"""
    import psutil
...
def verify_ports_unbound():
    """Rule 3: Port Liberation (v26.8) — with 10s retry grace period"""
    import socket
    import time
    import psutil
...
def main():
    logging.info("ADAPTIVE SENTINEL v26.8 Ironclad CADES Supervisor Active.")
