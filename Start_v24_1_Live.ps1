# Start_v24_1_Live.ps1
# Comprehensive Sentinel v24.1 Ironclad Startup

$PROJECT_ROOT = "C:\Sentinel_Project"
Set-Location $PROJECT_ROOT

Write-Host "##########################################################" -ForegroundColor Cyan
Write-Host "  ADAPTIVE SENTINEL v24.1 (Ironclad) - LIVE RESUMPTION" -ForegroundColor Cyan
Write-Host "##########################################################" -ForegroundColor Cyan
...
# 4. Start Profit Manager (Continuous 1Hz Ironclad Sweep)
...
Write-Host ""
Write-Host "[SUCCESS] Sentinel v24.1 Ironclad Pipeline is LIVE." -ForegroundColor Green
Write-Host "==========================================================" -ForegroundColor Cyan
