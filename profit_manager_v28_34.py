...
class SentinelProfitManager:
    ...
    def _apply_profit_locks(self, pos, ps, macro_atr, sl_mult, tp_mult, current_price, drawdown):
        """PURGED: Green Guard Trailing logic is strictly forbidden in Macro Swing mode."""
        pass
