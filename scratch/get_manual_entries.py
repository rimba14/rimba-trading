...
def main():
    ...
    # Targets from recent pending signals
    candidates = [
        {"symbol": "USDSGD", "direction": "SELL", "conviction": 0.347142, "hmm_state": "BEAR"},
        {"symbol": "EURAUD", "direction": "SELL", "conviction": 0.309942, "hmm_state": "BEAR"},
        {"symbol": "USDZAR", "direction": "SELL", "conviction": 0.268869, "hmm_state": "BEAR"}
    ]

    print("=== LIVE MANUAL ENTRY CALCULATIONS ===")
    for c in candidates:
        symbol = c["symbol"]
