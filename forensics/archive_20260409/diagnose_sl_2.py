...
with open("C:\\Sentinel_Project\\\emergency_report_2.txt", "w", encoding="utf-8") as f:
    f.write(f"=== EMERGENCY BALANCE REPORT 2 ===\n")
    ...
    # Pull deals from the last 3 hours (since v8.4 deploy)
    ...
    if deals:
        ...
        f.write(f"=== DEALS SINCE v8.4 DEPLOY (last 3h) ===\n")
        ...
        f.write("No deals found in the last 3 hours.\n")
...
mt5.shutdown()
print("Emergency report 2 written.")
